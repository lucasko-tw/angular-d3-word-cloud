# Contributing to d3-cloud-ng

d3-cloud-ng welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use d3-cloud-ng, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][stack] to see if it has been answered there, and post your question there if not. Please tag it with D3.js, and AngularJS.
...
* **d3-cloud-ng Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/d3-cloud-ng/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/d3-cloud-ng.git
$ cd d3-cloud-ng
$ git remote add upstream git://github.com/grtjn/d3-cloud-ng.git
```
...
Go to https://github.com/username/d3-cloud-ng and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/d3-cloud-ng/wiki
[stack]: http://stackoverflow.com/questions/tagged/d3.js+angularjs
[issue tracker]: https://github.com/grtjn/d3-cloud-ng/issues
